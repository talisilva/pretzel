package com.devoliga.ifood.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.devoliga.ifood.Controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Ifood").description("Projeto API Spring - Protótipo - Ifood")
